...
async function handleCallback(env, callback) {
    ...
    if (data === "admin_payments") {
        ...
        return sendMessage(
            ...
            [
                ...
                "",
                "Следующим этапом цена будет",
                "браться непосредственно из D1."
            ].join("\n"),
            {
                inline_keyboard: [
                    [
    ...
    if (data === "admin_staff_add") {
        ...
        return sendMessage(
            ...
            [
                ...
                "",
                "Новый администратор по умолчанию",
    ...
    // =====================================================
    // ВЫБОР АДМИНА ДЛЯ НАСТРОЙКИ ПРАВ
    // =====================================================
    ...
    // admin_perm_toggle_123456_courses
    if (
        data.startsWith(
            "admin_perm_toggle_"
        )
...
async function sendAdminMenu(
    ...
    return sendMessage(
        ...
        [
            ...
            access.isOwner
                ? "У вас полный доступ."
                : "Отображаются только разрешённые разделы."
        ].join("\n"),
        {
            inline_keyboard: keyboard
        }
    ...
    if (!editable.length) {
        return sendMessage(
            ...
            [
                ...
                "администраторов.",
                "",
                "Сначала добавьте администратора."
            ].join("\n"),
            backToStaffKeyboard()
        );
    }
